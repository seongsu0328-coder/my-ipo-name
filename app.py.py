...
def get_ai_analysis(company_name, topic, points):
    ...
    for i in range(max_retries):
        try:
            ...
            [필수 작성 규칙]
            1. "저는 분석가입니다", "요약을 시작합니다" 같은 서론이나 인사말을 절대 쓰지 마세요.
            2. 제목이나 소제목 없이 바로 본문 내용으로 시작하세요.
            3. 문체는 '해요'체 대신 전문적인 '합니다/입니다' 또는 간결한 개조식 문체를 사용하세요.
            ...
            전문적인 톤으로 위 내용을 한국어로 5줄 내외로 핵심만 요약하세요.
            """
