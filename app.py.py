...
if st.session_state.page == 'stats':
    ...
    with row2_col1:
        ...
        st.markdown("""
        **[정의]** 미국 중견기업(Mid-Cap) 편입  
        **[도달/존속]** 상장 후 평균 **12.5년** 소요 (수익 안정기)
        """)
    ...
    with row2_col2:
        ...
        st.markdown("""
        **[정의]** 미국 대기업(Large-Cap) 편입  
        **[도달/존속]** 상장 후 평균 **22년 이상** 유지 (시장 지배기)
        """)

    st.divider()
    st.info(f"💡 현재 시장 속도는 **{market_status}**입니다. 투자 시 각 생애주기별 리스크를 확인하세요.")
