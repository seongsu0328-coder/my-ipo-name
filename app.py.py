...
st.markdown("""
    ...
    .best-post { border: 2px solid #ffcc00 !important; background-color: #fffef0 !important; }
...
if st.session_state.auth_status is None:
    ...
    st.markdown(f"<div class='quote-card'><div style='font-style: italic; font-size: 18px; color: #444;'>“{q['text']}”</div><div style='color: #6e8efb; font-weight: bold; margin-top: 10px;'>- {q['author']} -</div></div>", unsafe_allow_html=True)
    st.stop()
