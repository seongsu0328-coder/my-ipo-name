...
if st.session_state.page == 'stats':
    ...
    stages = [
        {"name": "유아기", "img": "baby_unicorn.png", "desc": "상장 0~2년차 기업입니다. 성장이 가장 빠릅니다."},
        {"name": "아동기", "img": "child_unicorn.png", "desc": "상장 3~5년차 기업으로 시장에 안착 중입니다."},
        {"name": "성인기", "img": "adult_unicorn.png", "desc": "안정적인 수익을 내는 중견 유니콘입니다."},
        {"name": "노년기", "img": "old_unicorn.png", "desc": "S&P500 진입을 바라보는 거대 기업입니다."}
    ]
    ...
    with ci:
        if os.path.exists(stage['img']):
            ...
            st.warning(f"{stage['name']} 이미지를 찾을 수 없습니다.")
...
# ==========================================
    ...
    if not df.empty:
        ...
        # 순서: 가격 -> 주식수 -> 공모규모 -> 자금용도 -> 보호예수 -> 언더라이터 -> 거래소 -> 공시 -> 재무
        ...
        st.caption("※ 상세 정보는 '공시' 링크 내 S-1 서류를 참조하세요.")
    else:
