...
if st.session_state.page == 'stats':
    ...
    with row1_col1:
        ...
        except: st.write("(이미지 업로드 필요: baby_unicorn.png)")
    ...
    with row1_col2:
        ...
        except: st.write("(이미지 업로드 필요: child_unicorn.png)")
    ...
    with row2_col1:
        ...
        except: st.write("(이미지 업로드 필요: adult_unicorn.png)")
    ...
    with row2_col2:
        ...
        except: st.write("(이미지 업로드 필요: old_unicorn.png)")
