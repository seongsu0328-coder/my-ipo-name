            ...
            messages=[
                {
                    ...
                    1. 반드시 한국어로만 답변할 것.
                    2. 정보가 불분명하거나 숫자가 깨진 데이터는 무시하고 절대 출력하지 말 것.
                    3. 검색 결과에 기반하여 [창업주의 성별/나이/학력/창업전 경력 및 이전 창업이력, 기업소개/주력 제품 및 서비스, 핵심 BM 및 목표, 주력 시장 및 진출 목표, 산업 내 경쟁 우위 및 Cash Cow 여부, 최근 5년간 재무제표 추이] 정보를 포함할 것.
                    4. 반드시 전체 내용을 '10문장 이내'로 요약할 것.
                    5. 정보가 부족하면 '현재 해당 기업의 상세 비즈니스 모델 정보를 수집 중입니다'라고만 답변할 것."""
                },
                {
                    "role": "user", 
